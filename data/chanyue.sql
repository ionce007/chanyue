...
CREATE TABLE `sys_app`  (
  `id` int(2) NOT NULL AUTO_INCREMENT,
  `template` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'view模板名称',
...
-- Records of sys_app
-- ----------------------------
INSERT INTO `sys_app` VALUES (1, NULL, 's', 'x', 'x', 'x', 'x', 'x', '1', '2023-10-07 21:52:21', '2023-10-07 22:00:25');
