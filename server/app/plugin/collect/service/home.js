...
class CollectService {
  ...
  static async common() {
    try {
      const { data } = await axios.get('http://www.people.com.cn', {
        responseType: 'arraybuffer',
        headers: {
          'user-agent': 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/101.0.4951.64 Safari/537.36',
          'Referer': 'https://www.baidu.com/link?url=7jtB89POm3VK2XgaodEcEut721CA8ff3iUJhvghmRR4RqwrCScNkoLd9px_GHgaa&wd=&eqid=db27dc400000f76f0000000464fec4fd',
  ...
  static async getArticle(url) {
    try {
      ...
      return iconv.decode(data, 'gb2312') || data;
    } catch (err) {
      throw new Error(err)
    }
  }
